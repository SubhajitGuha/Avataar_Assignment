...
#include "glad/glad.h"
	...
	WindowsWindow::WindowsWindow(WindowProp& prop)
	{
		Init(prop);
	}
	...
	void WindowsWindow::Init(WindowProp& prop)
	{
		...
		Context = new OpenGlContext((std::shared_ptr<GLFWwindow>)m_window);//context for opengl as this piece of code is abstracted away
